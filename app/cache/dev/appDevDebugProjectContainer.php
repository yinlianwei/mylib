...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EM50a049b92ebc1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EM50a049b92ebc1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_diextra/doctrine/EntityManager.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_e59d80963cc65c25a2ccd2671ac0838f');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e59d80963cc65c25a2ccd2671ac0838f');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e59d80963cc65c25a2ccd2671ac0838f');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/src/Mylibber/MylibBundle/Entity')), 'Mylibber\\MylibBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MylibberMylibBundle' => 'Mylibber\\MylibBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM50a049b92ebc1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_BackendService()
    {
        ...
        return $this->services['security.firewall.map.context.backend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'backend', $b, $this->get('event_dispatcher')), 2 => $d, 3 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $this->get('security.authentication.manager'), 'backend', $e, $b), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $c, 'backend', $e, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/demo/secured/login', 'failure_path' => NULL, 'failure_forward' => false), $b), array('check_path' => '/demo/secured/login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/demo/secured/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('yinlianwei');
        $instance->setPassword('ylw0314798587');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EM50a049b92ebc1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_security/expressions');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'backend', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'secured_area', $b, true)), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev',
            'kernel.logs_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/logs',
            'kernel.bundles' => array(
                ...
                'MylibberMylibBundle' => 'Mylibber\\MylibBundle\\MylibberMylibBundle',
                'MylibberBackendBundle' => 'Mylibber\\BackendBundle\\MylibberBackendBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'mylib2',
            'database_user' => 'root',
            'database_password' => 'evenvi',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'yinlianwei',
            'mailer_password' => 'ylw0314798587',
            'locale' => 'en',
            ...
            'debug.container.dump' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.transport.smtp.username' => 'yinlianwei',
            'swiftmailer.transport.smtp.password' => 'ylw0314798587',
            ...
            'swiftmailer.spool.memory.path' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/../web',
            'assetic.write_to' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM50a049b92ebc1_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/home/evenvi/Zend/workspaces/DefaultWorkspace/Mylib/app/cache/dev/jms_security',
