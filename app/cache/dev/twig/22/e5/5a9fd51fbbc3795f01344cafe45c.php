...
class __TwigTemplate_22e55a9fd51fbbc3795f01344cafe45c extends Twig_Template
{
...
";
    ...
    <tr>
        ...
        <th><span class=\"label label-info\">借阅日期:</span></th>
        <th><span class=\"label label-info\">归还日期:</span></th></tr>
";
        // line 45
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["borr"]) {
            ...
            <td>";
            // line 58
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "borr"), "givebackDate"), "html", null, true);
            echo "</td>
";
        }
...
";
    ...
    {
        return array (  131 => 60,  123 => 58,  119 => 57,  115 => 56,  111 => 55,  107 => 54,  101 => 53,  97 => 52,  90 => 47,  87 => 46,  83 => 45,  72 => 36,  70 => 35,  41 => 9,  33 => 5,  27 => 3,);
    }
}
